        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Kategori Soal</div>
                    <div class="panel-body">
                        <a href="{{ url('/kategori-soal/create') }}" class="btn btn-success btn-sm" title="Add New KategoriSoal">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/kategori-soal', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
